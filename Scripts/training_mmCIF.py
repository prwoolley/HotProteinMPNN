...
def main(args):
    ...
    from utils_mmCIF import worker_init_fn, get_pdbs, loader_pdb, build_training_clusters, PDB_dataset, StructureDataset, StructureLoader
    from model_utils_mmCIF import featurize, loss_smoothed, loss_nll, get_std_opt, ProteinMPNN
